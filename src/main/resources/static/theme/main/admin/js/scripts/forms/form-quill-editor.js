...
(function (window, document, $) {
  ...
  //term-con-content th
  var termTh = new Quill('#editor-termTh .editor', {
    bounds: '#full-container .editor',
    modules: {
      formula: true,
      syntax: true,
  ...
  //term-con-content en
  var termEn = new Quill('#editor-termEn .editor', {
    bounds: '#full-container .editor',
    modules: {
      formula: true,
      syntax: true,
  ...
  //consent-content th
  var consentTh = new Quill('#editor-consentTh .editor', {
    bounds: '#full-container .editor',
    modules: {
      formula: true,
      syntax: true,
  ...
  //consent-content en
  var consentEn = new Quill('#editor-consentEn .editor', {
    bounds: '#full-container .editor',
    modules: {
      formula: true,
      syntax: true,
  ...
  var editors = [bubbleEditor, snowEditor, fullEditor,termTh ,termEn,consentTh,consentEn];
